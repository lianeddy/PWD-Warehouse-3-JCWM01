...
import AppUserAdminCreateUpdate from "./AppUserAdminCreateUpdate";
...
class AppUserAdminView extends React.Component {
  state = {
    show: false,
    modalTitle: "",
    isAddData: true,
...
export default connect(mapStateToProps, mapDispatchToProps)(AppUserAdminView);
