...
module.exports = {
  ...
  deleteItemInCart: async (req, res, next) => {
    // query sql
    const querySelect = 'SELECT * FROM app_carts_produk WHERE id_app_carts_produk = ?'
    const queryDelete = 'DELETE FROM app_carts_produk WHERE id_app_carts_produk = ?'
  ...
  editQtyItemInCart: async (req, res, next) => {
    ...
    // query sql
    const querySelect = 'SELECT * FROM app_carts_produk WHERE id_app_carts_produk = ?'
    const queryEditQty = 'UPDATE app_carts_produk SET ? WHERE id_app_carts_produk = ?'
