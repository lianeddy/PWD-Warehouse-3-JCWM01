...
module.exports = {
  productList: (request, response) => {
    ...
    let scriptQuery = `select * from fp_pwd_5.products p 
        ...
        }%' and warehouse_id = ${request.query.warehouse_id}
  ...
  editProduct: (request, response) => {
    ...
    let editQuery = `update fp_pwd_5.products set ${dataJoined} where product_id = ${db.escape(
  ...
  editStock: (request, response) => {
    ...
    let editQuery = `update fp_pwd_5.warehouse_stock set ${dataJoined} where warehouse_stock_id = ${db.escape(
      request.query.warehouse_stock_id
    )};`;
