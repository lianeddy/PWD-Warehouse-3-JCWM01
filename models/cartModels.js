...
module.exports = {
    getCartMdl: async function (response, searchStatement, getStatement, id, data) {
        ...
        try {
            ...
            const table = ['app_carts_produk INNER JOIN app_master_produk ON app_carts_produk.id_master_barang = app_master_produk.id_master_produk INNER JOIN sys_user ON app_carts_produk.id_user = sys_user.id_user', id]
    ...
    deleteItemInCartMdl: async function (response, searchStatement, deleteStatement, id) {
    ...
    editQtyItemInCartMdl: async function (response, searchStatement, editStatement, id, data) {
        try {
            // find item in cart
            const searchData = await db.query(searchStatement, id).catch(err => {
                throw {
            ...
            // Check item exists
            if (searchData.length) {
                const editQtyInData = await db.query(editStatement, [data, id]).catch(err => {
                    throw {
